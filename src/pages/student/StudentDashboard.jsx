...
import { 
  ...
  Info, Download, Menu, X, Wallet, Camera, Save, Edit3
} from 'lucide-react';
  ...
  return (
    <div className="flex h-screen bg-[#f8fafc] overflow-hidden font-sans">
      ...
      <main className="flex-1 overflow-y-auto relative flex flex-col">
          ...
          <div className="flex items-center gap-3 relative">
            ...
            >
              {studentData?.profile_image ? (
                <img src={`${API_BASE_URL}/uploads/profiles/${studentData.profile_image}`} className="w-full h-full object-cover" />
              ) : (
        ...
        {/* DASHBOARD CONTENT (WALANG BINAGO) */}
        <div className="max-w-6xl mx-auto p-6 md:p-12 w-full">
          <header className="mb-10 animate-in fade-in slide-in-from-top-4 duration-500">
            ...
            <p className="text-slate-400 font-bold uppercase text-[10px] tracking-[0.3em]">Student ID: {studentData?.student_id || '2026-0004'}</p>
          </header>
      ...
      {/* --- EDIT PROFILE MODAL (SAKTONG LAKI) --- */}
      {isEditModalOpen && (
